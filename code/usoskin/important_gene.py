...
W = np.loadtxt("../model_weight/usoskin_weight/layer_weight/W2 30 .txt")
W = np.transpose(W)
...
print(df2.shape)
df2.to_csv('impor_weight_all3.csv')
print(len(edge_ind))
...
file_handle=open('usoskin_total.txt',mode='w')
...
file_handle=open('usoskin_total_node.txt',mode='w')
